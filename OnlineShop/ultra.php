          ...
          <div class="row mt-5 no-gutters" id="atas">
            ...
            <div class="col-md-2 bg-light ">
                    <ul class="list-group list-group-flush p-2 pt-4">
                            <li class="list-group-item text-white  wow fadeInDown"  style="background: #15161D;">
           ...
           <!--/Dashboard-->
            ...
            <div class="col-md-10 mt-2" >
                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                          ...
                          <div class="container">
`               <h4 class="text-center font-weight-bold m-4" id="barang" >PRODUK ULTRA COOL</h4>

                    <div class="row mx-auto wow fadeInDown" >
                            <div class="card mr-2 ml-2 " style="width: 16rem;">
                                    <img class="card-img-top" src="img/ultracool/1.jpg" alt="Card image cap">
                                    <div class="card-body bg-light">
                                      <h5 class="card-title">Ice Pack Mini</h5>
                                      <p class="card-text"> Ukuran 450gr 17 x 9 x 3 cm</p>
                                      ...
                                      <a href="#" class="btn btn-danger">Rp. 50.000</a>
                                    </div>
                                </div>
                                ...
                                <div class="card mr-2 ml-2 " style="width: 16rem;">
                                        ...
                                        <div class="card-body bg-light">
                                          ...
                                          <p class="card-text">Ukuran 700gr 22 x 9 x 3 cm</p>
                                            <i class="fas fa-star text-warning"></i>
                                            <i class="fas fa-star text-warning"></i>
                                            <i class="fas fa-star text-warning"></i>
                                            <i class="fas fa-star-half-alt text-warning"></i>
                                    ...
                                    <div class="card mr-2 ml-2 " style="width: 16rem;">
                                            <img class="card-img-top" src="img/ultracool/9051422_ee214233-8b65-4d34-a7c9-7b96b455089e_2048_2047.jpg" alt="Card image cap">
                                            <div class="card-body bg-light">
                                              <h5 class="card-title">Ice Gel Sachet</h5>
                                              <p class="card-text">Ukuran 300ml 19x11,5x2 cm</p>
                                                <i class="fas fa-star text-warning"></i>
                                                <i class="fas fa-star text-warning"></i>
                                                <i class="fas fa-star text-warning"></i>
                                                <i class="fas fa-star-half-alt text-warning"></i>
                                              ...
                                              <a href="#" class="btn btn-danger">Rp. 15.000</a>
                                            </div>
                                        </div>
