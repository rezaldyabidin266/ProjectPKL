           ...
           <!--/Dashboard-->
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-10 mt-2" >
                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                          ...
                          <div class="container">
`               <h4 style="font-family: 'font4';" class="text-center font-weight-bold m-4 mb-5" id="barang" >Login Pelanggan</h4>
                            <div class="row">
                               ...
                               <div class="form-group">
                                    ...
                                    <button class="btn btn-dark" name="simpan">Send</button>
                               </form>
                               ...
                               <?php 
                                ...
                                if(isset($_POST["simpan"]))
                                {
                                  ...
                                  // Ngitung Akun Yang masuk
                                  $akunyangcocok = $ambil->num_rows;

                                  //jika akun 1 cocok boleh login
                                  if($akunyangcocok==1)
                                  {
                                    //anda login
                                    //mendapatkan akun dlm bentuk array
                                    $akun = $ambil->fetch_assoc();
                                    //simpan di senssion pelanggan
