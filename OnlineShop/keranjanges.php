        ...
        <div class="container">
                ...
                <ul class="navbar-nav ml-auto mr-4">
                    ...
                    <a class="nav-link text-white" href="index.php">Beranda <span class="sr-only">(current)</span></a>
                     ...
                     <li class="nav-item active">
                    <a class="nav-link text-white" href="order.html">Order<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item active">
           ...
           <!--/Dashboard-->
            ...
            <div class="col-md-10 mt-2" >
                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                          ...
                          <div class="container">
`               <h4 class="text-center font-weight-bold m-4" id="barang" >PRODUK KERANJANG</h4>

                    <div class="row mx-auto wow fadeInDown" >
                            <div class="card mr-2 ml-2 " style="width: 16rem;">
                                    <img class="card-img-top" src="img/keranjang/9051422_12360091-9878-416f-903b-b9c320b714c7_2048_2048.jpg" alt="Card image cap">
                                    <div class="card-body bg-light">
                                      <h5 class="card-title">Keranjang Es</h5>
                                      <p class="card-text"> Ukuran 56,5 x 21 x 24</p>
                                      ...
                                      <a href="#" class="btn btn-danger">Rp. 105.000</a>
                                    </div>
                                </div>

                                <div class="card mr-2 ml-2 " style="width: 16rem;">
                                        <img class="card-img-top" src="img/keranjang/9051422_b11faefb-b872-403d-a8ab-17433a67eb00_2048_2048 (1).jpg" alt="Card image cap">
                                        <div class="card-body bg-light">
                                          <h5 class="card-title">Keranjang Es</h5>
                                    ...
                                    <div class="card mr-2 ml-2 " style="width: 16rem;">
                                            <img class="card-img-top" src="img/keranjang/9051422_b2821170-b508-4505-b3ed-049cad398fe2_1900_1900.jpg" alt="Card image cap">
                                            <div class="card-body bg-light">
                                              <h5 class="card-title">Keranjang Es</h5>
                                              <p class="card-text">Ukuran 42 x 21 x 24</p>
                                                <i class="fas fa-star text-warning"></i>
                                                <i class="fas fa-star text-warning"></i>
                                                <i class="fas fa-star text-warning"></i>
                                                <i class="fas fa-star-half-alt text-warning"></i>
                                        ...
                                        <div class="card mr-2 ml-2 " style="width: 16rem;">
                                                <img class="card-img-top" src="img/keranjang/9051422_f04ca876-4050-4ba4-84a6-734da4ee282a_1900_1900.jpg" alt="Card image cap">
                                                <div class="card-body bg-light">
                                                  <h5 class="card-title">Keranjang Es</h5>
                                                  <p class="card-text">Ukuran 45 x 21 x 24</p>
                                                    <i class="fas fa-star text-warning"></i>
                                                    <i class="fas fa-star text-warning"></i>
                                                    <i class="fas fa-star text-warning"></i>
                                                    <i class="fas fa-star-half-alt text-warning"></i>
                                                    <i class="far fa-star text-warning"></i><br>
                                                  <a href="#" class="btn btn-primary">Detail</a>
                                                  <a href="#" class="btn btn-danger">Rp. 155.000</a>
                                                </div>
                                            </div>
                    </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="row">
                  <div class="col-md-6">
                    <img src="img/box/9051422_7fead262-1cc4-4af0-81ec-b4ab9d19ed0e_2048_2048.jpg" alt="">
                  </div>
                  <div class="col-md-6">
