           ...
           <!--/Dashboard-->
            ...
            <div class="col-md-10 mt-2" >
                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                          ...
                          <div class="container">
`               <h4 class="text-center font-weight-bold m-4" id="barang" >PRODUK STYROFOM</h4>
                    ...
                    <div class="row mx-auto wow fadeInDown" >
                            <div class="card mr-2 ml-2 " style="width: 16rem;">
                                ...
                                <div class="card mr-2 ml-2 " style="width: 16rem;">
                                        <img class="card-img-top" src="img/box/9051422_93e509a5-e87f-4455-8298-1152363a0093_2048_2047.jpg" alt="Card image cap">
                                        <div class="card-body bg-light">
                                          <h5 class="card-title">Box BM</h5>
                                          <p class="card-text">Ukuran 34 x 25 x 30</p>
                                            <i class="fas fa-star text-warning"></i>
                                            <i class="fas fa-star text-warning"></i>
                                            <i class="fas fa-star text-warning"></i>
                                            <i class="fas fa-star-half-alt text-warning"></i>
                                          ...
                                          data-toggle="modal">Detail</a>
                                          <a href="#" class="btn btn-danger">Rp. 18.000</a>
                                        </div>
                                    </div>

                                    <div class="card mr-2 ml-2 " style="width: 16rem;">
                                            <img class="card-img-top" src="img/box/9051422_9966f5d1-b514-46ce-8622-29bed83612ca_2048_2047.jpg" alt="Card image cap">
                                            <div class="card-body bg-light">
                                              <h5 class="card-title">Box GG Baru</h5>
                                              <p class="card-text">Ukuran 52 x 37 x 35</p>
                                                <i class="fas fa-star text-warning"></i>
                                                <i class="fas fa-star text-warning"></i>
                                                <i class="fas fa-star text-warning"></i>
                                                <i class="fas fa-star-half-alt text-warning"></i>
                                              ...
                                              <a href="#" class="btn btn-danger">Rp. 35.000</a>
                                            </div>
                                        </div>

                                        <div class="card mr-2 ml-2 " style="width: 16rem;">
                                                <img class="card-img-top" src="img/box/9051422_c5a41c9d-83ca-494d-8670-b91d8632fa45_2048_2047.jpg" alt="Card image cap">
                                                <div class="card-body bg-light">
                                                  <h5 class="card-title">BM Hard</h5>
                                                  <p class="card-text">Ukuran 34 x 25 x 30</p>
                                                    <i class="fas fa-star text-warning"></i>
                                                    <i class="fas fa-star text-warning"></i>
                                                    <i class="fas fa-star text-warning"></i>
