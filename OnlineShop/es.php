           ...
           <!--/Dashboard-->
            ...
            <div class="col-md-10 mt-2" >
                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                          ...
                          <div class="container">
`               <h4 class="text-center font-weight-bold m-4" id="barang" >PRODUK ICE CREAM</h4>

                    <div class="row mx-auto wow fadeInDown" >
                            <div class="card mr-2 ml-2 " style="width: 16rem;">
                                    <img class="card-img-top" src="img/es/7.jpg" alt="Card image cap">
                                    <div class="card-body bg-light">
                                      <h5 class="card-title">Ice Cream</h5>
                                      <p class="card-text"> Rasa Coklat</p>
                                ...
                                <div class="card mr-2 ml-2 " style="width: 16rem;">
                                        <img class="card-img-top" src="img/es/8.jpg" alt="Card image cap">
                                        <div class="card-body bg-light">
                                          <h5 class="card-title">Ice Cream Box</h5>
                                          <p class="card-text">Hindangan Untuk Keluarga</p>
                                            <i class="fas fa-star text-warning"></i>
                                            <i class="fas fa-star text-warning"></i>
                                            <i class="fas fa-star text-warning"></i>
                                            <i class="fas fa-star-half-alt text-warning"></i>
                                          ...
                                          data-toggle="modal">Detail</a>
                                          <a href="#" class="btn btn-danger">Rp. 5.000</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card mr-2 ml-2 " style="width: 16rem;">
                                            ...
                                            <div class="card-body bg-light">
                                              <h5 class="card-title">Ice Cream</h5>
                                              <p class="card-text">Rasa Buah Segar</p>
                                                <i class="fas fa-star text-warning"></i>
                                                <i class="fas fa-star text-warning"></i>
                                                <i class="fas fa-star text-warning"></i>
                                                <i class="fas fa-star-half-alt text-warning"></i>
                                        ...
                                        <div class="card mr-2 ml-2 " style="width: 16rem;">
                                                ...
                                                <div class="card-body bg-light">
                                                  <h5 class="card-title">Ice Cream</h5>
                                                  <p class="card-text">Cemilan Sehat</p>
                                                    <i class="fas fa-star text-warning"></i>
                                                    <i class="fas fa-star text-warning"></i>
                                                    <i class="fas fa-star text-warning"></i>
                                                    <i class="fas fa-star-half-alt text-warning"></i>
                                                    <i class="far fa-star text-warning"></i><br>
                                                  <a href="#" class="btn btn-primary">Detail</a>
                                                  <a href="#" class="btn btn-danger">Rp. 12.000</a>
                                                </div>
                                            </div>
                    </div>
